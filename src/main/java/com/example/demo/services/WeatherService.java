...
public class WeatherService {
    ...
    public List<WeatherModel> getWeather(String city, String country, String date){
        Date timestampFrom = Date.valueOf(date);
        Date timestampTo = Date.valueOf(timestampFrom.toLocalDate().plusDays(1));
        return weatherRepository.findByTimestampBetweenAndCityAndCountry(timestampFrom, timestampTo, city, country);
    }
